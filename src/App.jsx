  ...
  return (
    <Layout style={{ height: "100vh", overflow: "auto" }}>
      <Router>
        ...
        {/* <img class='logo1' src='https://daoagents.s3.amazonaws.com/meta-dao-wallet2.jpg'></img> */}
          ...
          <div style={styles.headerRight}>
            ...
            <TokenPrice
              ...
              chain="eth"
              image="https://cdn.pixabay.com/photo/2021/05/24/09/15/ethereum-6278326_960_720.png"
              size="50px"
            />
            <NativeBalance />
            <Account />
        ...
        <div style={styles.content}>
          <Switch>
            ...
            <Route path="/barter-swap">
              <Tabs defaultActiveKey="1" style={{ alignItems: "center" }}>
                <Tabs.TabPane tab={<h4 class='jin'>Ethereum</h4>} key="1">
                  <DEX chain="eth" />
                </Tabs.TabPane>
                <Tabs.TabPane tab={<h4 class='jin2'>Binance Smart Chain</h4>} key="2">
                  <DEX chain="bsc" />
                </Tabs.TabPane>
                <Tabs.TabPane tab={<h4 class='jin3'>Polygon</h4>} key="3">
                  <DEX chain="polygon" />
                </Tabs.TabPane>
              </Tabs>
            </Route>
      ...
      <img class='size' src='https://daoagents.s3.amazonaws.com/meta-dao-agents.jpg'></img>


      {/* <Footer style={{ textAlign: "center" }}> */}
        {/* <Text style={{ display: "block" }}>
          The app may be a little slow to render as it is in beta, your patience is appreciated.
        </Text> */}
